...
| [**C++/Headers**](./Headers)             | A folder containing **header-only C++ libraries** like `SMART.hpp` (for SMART info) or `Live.hpp` (C++ header-only version of LiveView), and others.                                                                                                                                                                                                                                                             | 🟨 C++     | Header-only C++ modules for advanced hardware access and monitoring.                                   |
